...
class Chars2Vec:
    ...
    def fit(self, word_pairs, targets,
        ...
        x_1_pad_seq = tf.keras.utils.pad_sequences(x_1)
        x_2_pad_seq = tf.keras.utils.pad_sequences(x_2)
    ...
    def vectorize_words(self, words, maxlen_padseq=None):
        ...
        if len(new_words) > 0:
            ...
            embeddings_pad_seq = tf.keras.utils.pad_sequences(list_of_embeddings, maxlen=maxlen_padseq)
